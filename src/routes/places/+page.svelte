<script lang="ts">
	...
	// Deep link (e.g. from the rate flow or a recommendation card):
	// /places?place=<id> flies to + opens that place.
...
<!--
  ...
  on this route (/places). Search is now a top-left overlay inside
  MapView itself.
-->
